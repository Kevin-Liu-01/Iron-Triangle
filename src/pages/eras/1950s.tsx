          ...
          >
            ...
            <div className="relative z-10 mx-auto flex h-full max-w-7xl flex-col items-center justify-center px-8 ">
              ...
              <p className="col-span-2 mt-8">
                {
                  "In the 1950s, the business and military-industrial complex held significant sway over American policy, particularly due to the ongoing Cold War and the defense industry's pivotal role. As the United States and the Soviet Union engaged in an intense arms race and the nation grappled with fears of Communism, defense contractors successfully advocated against disarmament, arguing instead for increased war production. The close ties between these contractors and policymakers led to a heightened focus on military preparedness and a surge in defense spending, resulting in substantial profits for the defense industry."
                }
              </p>
            </div>
          </header>
              ...
              <div className="mx-auto grid max-w-7xl gap-x-12 sm:grid-cols-2">
                ...
                <div className="flex flex-col justify-center ">
                  <div className="text-5xl font-extrabold ">
                    Artifact 2:{" "}
                    <span className="text-red-500">
                      United Fruit Company Delivery (1954)
                    </span>
                  </div>
                  <div className="mt-4 text-2xl font-light">
                    The military industrial complex was not the only industry
                    that benefited from deep connections to the government. In
                    1954, the United Fruit Company, a fruit company that
                    operated in Central America, was able to use its connections
                    to organize a coup in Guatemala, deposing a democratically
                    elected president.
                  </div>
                </div>
              </div>
            ...
            <div className="w-[100vw] bg-gray-200 p-8 dark:bg-[#212020]">
              <div className="mx-auto grid max-w-7xl gap-x-12 sm:grid-cols-3">
                ...
                <div className="col-span-2 flex flex-col justify-center">
                  <div className="text-5xl font-extrabold ">
                    Artifact 3:{" "}
                    <span className="text-red-500">The Power Elite (1956)</span>
                  </div>
                  <div className="mt-4 text-2xl font-light">
                    Written by C. Wright Mills in 1956,{" "}
                    <span className="italic">The Power Elite</span> is a book
