    ...
    <main className="relative overflow-hidden  bg-white duration-150 dark:bg-black">
      <div className="font-hanken">
        ...
        <section className="scrollbar max-h-[calc(100vh-5rem-1.5px)] min-h-[calc(100vh-5rem-1.5px)] overflow-x-hidden overflow-y-scroll">
          <section className="mx-auto max-w-7xl px-8 pb-8 2xl:px-0">
            <div className="mt-8 text-6xl font-extrabold">Sources</div>
            <div className="mt-4 flex flex-col rounded-lg bg-gray-300 p-4 shadow-inner dark:bg-[#1d1d1d]">
              <p className="text-2xl font-extrabold">The 1940s</p>
              <div className="mt-4 grid gap-4 sm:grid-cols-2">
                <div className="h-full rounded-md bg-white p-2 dark:bg-black">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <Link
                      ...
                      className="flex items-center rounded-md bg-gray-200 p-2 duration-150 hover:bg-gray-300 dark:bg-[#101010] dark:hover:bg-gray-800"
                    >
